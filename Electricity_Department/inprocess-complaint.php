...
*/
$st = 'in process';
$department = 'Electricity Department'; // Change this to the department you want to filter by
//$query = mysqli_query($bd, "SELECT tblcomplaints.*, users.fullName AS name FROM tblcomplaints JOIN users ON users.id = tblcomplaints.userId WHERE tblcomplaints.status = '$st' AND tblcomplaints.subcategory = '$department'");
...
$query = mysqli_query($bd, "SELECT tblcomplaints.*, users.fullName AS name 
                            ...
                            AND tblcomplaints.subcategory = '$department'
